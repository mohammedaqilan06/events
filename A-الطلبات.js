...
api.changeNickname(`${(!global.config.BOTNAME) ? "Made by Mohammed Ps🖤🥀" : global.config.BOTNAME}`, handleReply.pending[singleIndex - 1].threadID, api.getCurrentUserID());
            api.sendMessage("", event.threadID, () => api.sendMessage({body:` -أنضم لقناة البوت لمزيد من المعلومات عن كيفية أستخدام البوت\n https://...  `, attachment: fs.createReadStream(__dirname + "/rankup/trolled.mp3")} ,handleReply.pending[singleIndex - 1].threadID));
            count+=1;
