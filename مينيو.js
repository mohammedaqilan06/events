...
module.exports.handleReply = async function ({ api, event, handleReply }) {
	...
	const img = ["https://i.postimg.cc/Gmxt17kJ/me-2.jpg", "https://i.postimg.cc/FHymLYz9/mmm.jpg",
"https://i.postimg.cc/fTxTx2gn/me.jpg",
"https://i.postimg.cc/VNNfPYsm/me-3.jpg"
 ]
...
module.exports.run = async function({ api, event, args }) {
	...
	const fs = require('fs-extra');
	const imgP = []
	const img = ["https://i.postimg.cc/NGdKKPVN/men1.jpg"
,"https://i.postimg.cc/T1BGrmnP/meem.jpg"]
	var path = __dirname + "/cache/menu.jpg"
	var rdimg = img[Math.floor(Math.random() * img.length)]; 
